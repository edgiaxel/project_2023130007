    ...
    <div class="py-12" style="background-color: #0d0d1f;">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 border-t-4 border-red-500">
                <h3 class="text-lg font-bold text-gray-200 mb-4">Platform Accounts List (Excluding Me)</h3>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-700">
                        ...
                        <tbody class="bg-gray-800 divide-y divide-gray-700 text-gray-200">
                            ...
                            $color = ['admin' => 'bg-red-600', 'renter' => 'bg-pink-600', 'user' => 'bg-blue-600',
                            'Unassigned' => 'bg-gray-500'][$role] ?? 'bg-gray-500';
                            @endphp
                            <tr>
