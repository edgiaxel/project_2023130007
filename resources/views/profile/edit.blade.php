<x-app-layout>
    ...
    <div class="py-12" style="background-color: #0d0d1f;">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- 1. STANDARD PROFILE INFO (for all roles) --}}
            ...
            {{-- 2. RENTER STORE SETUP (Only visible to Renters) --}}
            @if (Auth::user()->hasRole('renter'))
                <div class="p-4 sm:p-8 bg-gray-800 shadow sm:rounded-lg border-t-4 border-pink-500">
                    <div class="max-w-xl">
                        ...
                        {{-- This partial will be created next --}}
                    </div>
                </div>
            @endif

            {{-- 3. PASSWORD UPDATE (for all roles) --}}
            ...
            {{-- 4. DELETE ACCOUNT (for all roles) --}}
